        ...
        {items.map((item) => {
          ...
          return (
            <View key={key} style={styles.card}>
              ...
              <TouchableOpacity style={styles.editAiBtn} activeOpacity={0.85}>
                <MaterialIcons name="photo-filter" size={18} color={WHITE} />
                <Text style={styles.editAiText}>تعديل بالذكاء الصناعي</Text>
              </TouchableOpacity>
            </View>
          );
        })}
...
const styles = StyleSheet.create({
  ...
  editAiText: { color: WHITE, fontFamily: 'NotoSansArabic_700Bold' },
