  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: Math.max(insets.top, 12) }]}>
      ...
      {!hasSearched && (
        <View style={styles.sectionContainer}>
          <View style={styles.sectionHeader}>
            ...
            <MaterialIcons name="category" size={18} color={BRAND_COLORS.primary}/>
          </View>
          ...
          <View style={styles.categoriesContainer}>
            <View style={styles.categoriesRow}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                onPress={handleCategoriesScrollLeft}
                accessible={true}
                accessibilityLabel="تمرير للخلف"
                accessibilityRole="button"
              >
                <MaterialIcons name="chevron-left" size={20} color={BRAND_COLORS.primary} />
              </TouchableOpacity>
              ...
              <ScrollView
                ...
                onScroll={handleCategoriesScrollUpdate}
              ...
              <TouchableOpacity
                style={styles.categoriesArrow}
                activeOpacity={0.7}
                onPress={handleCategoriesScrollRight}
                accessible={true}
                accessibilityLabel="تمرير للأمام"
                accessibilityRole="button"
              >
                <MaterialIcons name="chevron-right" size={20} color={BRAND_COLORS.primary} />
              </TouchableOpacity>
            </View>
      ...
      {!hasSearched && (
        <View style={styles.sectionContainer}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>التسليطات</Text>
            <MaterialIcons name="star" size={18} color={BRAND_COLORS.primary}/>
          </View>
          ...
          <View style={styles.categoriesContainer}>
            <View style={styles.categoriesRow}>
              <TouchableOpacity
                style={styles.categoriesArrow}
                activeOpacity={0.7}
                onPress={handleHighlightsScrollLeft}
                accessible={true}
                accessibilityLabel="تمرير للخلف"
                accessibilityRole="button"
              >
              ...
              <ScrollView
                ...
                showsHorizontalScrollIndicator={false}
                contentContainerStyle={styles.categoriesScrollContent}
                onScroll={handleHighlightsScrollUpdate}
                scrollEventThrottle={16}
                accessible={true}
              ...
              <TouchableOpacity
                style={styles.categoriesArrow}
                activeOpacity={0.7}
                onPress={handleHighlightsScrollRight}
                accessible={true}
                accessibilityLabel="تمرير للأمام"
                accessibilityRole="button"
              >
